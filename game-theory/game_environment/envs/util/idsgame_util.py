...
import io
import cv2
#from game_environment.envs.dao.idsgame_config import IdsGameConfig
#from game_environment.envs.dao.game_config import GameConfig
#from game_environment.envs.dao.game_state import GameState
from gym_idsgame.envs.dao.node_type import NodeType
#from game_environment.envs.dao.network_config import NetworkConfig
...
def interpret_attack_action(action: int, game_config) -> Union[int, Union[int, int], int, bool]:
    ...
    """
    if not game_config.reconnaissance_actions:   # 这里的 num_attack_types不用变
