...
def plot_summary(algorithm : str, eval_freq : int, train_log_freq : int):
    ...
    try:
        ...
        for seed in seeds:
            maximal_attack_train_csv_path = glob.glob(base_dir + "/version/maximal_attack/" + algorithm +
                                                      "/results/data/" + str(seed) + "/*_train.csv")[0]
            maximal_attack_eval_csv_path = glob.glob(base_dir + "/version/maximal_attack/" + algorithm +
                                                     "/results/data/" + str(seed) + "/*_eval.csv")[0]
        ...
        for seed in seeds:
            base_dir = default_output_dir()
            minimal_defense_train_csv_path = glob.glob(base_dir + "/version/minimal_defense/" + algorithm +
                                                       "/results/data/" + str(seed) + "/*_train.csv")[0]
            minimal_defense_eval_csv_path = glob.glob(base_dir + "/version/minimal_defense/" + algorithm +
                                                      "/results/data/" + str(seed) + "/*_eval.csv")[0]
        ...
        for seed in seeds:
            base_dir = default_output_dir()
            random_attack_train_csv_path = glob.glob(base_dir + "/version/random_attack/" + algorithm +
                                                     "/results/data/" + str(seed) + "/*_train.csv")[0]
            random_attack_eval_csv_path = glob.glob(base_dir + "/version/random_attack/" + algorithm +
                                                    "/results/data/" + str(seed) + "/*_eval.csv")[0]
        ...
        for seed in seeds:
            base_dir = default_output_dir()
            random_defense_train_csv_path = glob.glob(base_dir + "/version/random_defense/" + algorithm +
                                                      "/results/data/" + str(seed) + "/*_train.csv")[0]
            random_defense_eval_csv_path = glob.glob(base_dir + "/version/random_defense/" + algorithm +
                                                     "/results/data/" + str(seed) + "/*_eval.csv")[0]
        ...
        for seed in seeds:
            base_dir = default_output_dir()
            two_agents_train_csv_path = glob.glob(base_dir + "/version/two_agents/" + algorithm +
                                                  "/results/data/" + str(seed) + "/*_train.csv")[0]
            two_agents_eval_csv_path = glob.glob(base_dir + "/version/two_agents/" + algorithm +
                                                 "/results/data/" + str(seed) + "/*_eval.csv")[0]
        ...
        print("could not plot v7,version,v9")
        print(str(e))
...
def plot():
    ...
    try:
        hyperparam_csv_path = glob.glob(default_output_dir() +
                                        "/v0/random_defense/EDQL/results/hyperparameters/0/*.csv")[0]
        hyperparameters = pd.read_csv(hyperparam_csv_path)
    except:
        hyperparam_csv_path = glob.glob(default_output_dir() +
                                        "/version/random_defense/EDQL/results/hyperparameters/0/*.csv")[0]
        hyperparameters = pd.read_csv(hyperparam_csv_path)
    ...
    try:
        plot_summary("EDQL", int(eval_freq), int(train_log_freq))
    except Exception as e:
